#pragma checksum "C:\inetpub\wwwroot\blazor\library\jQWidgets.Blazor\Components\JqxMaskedInput.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2acd5ac09e4702a1626a1012d86b09a13175274a"
// <auto-generated/>
...
#line default
#line hidden
#line 1 "C:\inetpub\wwwroot\blazor\library\jQWidgets.Blazor\Components\JqxMaskedInput.razor"
using System.Text.Json;

#line default
#line hidden
    public partial class JqxMaskedInput : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#line 4 "C:\inetpub\wwwroot\blazor\library\jQWidgets.Blazor\Components\JqxMaskedInput.razor"
          componentID
...
#line 6 "C:\inetpub\wwwroot\blazor\library\jQWidgets.Blazor\Components\JqxMaskedInput.razor"
    ...
    [Parameter]
    public string mask {
        get { return getterProp<string>("mask"); }
        set { setterProp("mask", value); }
    }
    ...
    private string[] paramsToBlock = { "onComponentReady", "ChildContent", "onChange", "onValueChanged" };
    ...
    protected override void OnAfterRender(bool firstRender)
    {
        if (firstRender)
        {
            ((IJSInProcessRuntime)JSRuntime).InvokeVoid("jqxBlazor.createComponent", componentID, "jqxMaskedInput", initialOptions);
    ...
    {
        ((IJSInProcessRuntime)JSRuntime).Invoke<object>("jqxBlazor.manageEvents", componentID, "change", "emitMaskedInputEvent", DotNetObjectReference.Create(new EventsHandler(onChange)));
        ((IJSInProcessRuntime)JSRuntime).Invoke<object>("jqxBlazor.manageEvents", componentID, "valueChanged", "emitMaskedInputEvent", DotNetObjectReference.Create(new EventsHandler(onValueChanged)));
    }
    ...
    public class EventsHandler
    {
        ...
        [JSInvokable]
        public void emitMaskedInputEvent(object e)
        {
