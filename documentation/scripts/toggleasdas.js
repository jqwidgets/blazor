...
$(document).ready(function () {
   ...
   $(".doc_menu a").click(function () {
			...
			// sloji tozi "window.location.toString()" v edin variable v na4aloto na script-a ;)
			// polazvash go sigurno 30 pyti
    ...
    if (testForIndex()) {
		...
		$.each(images,function(index, value)
		{
		  ...
		  if (formatCode) {
            ...
            if (winHref.indexOf("api.htm") >= 0 || winHref.indexOf("knockoutjs") >= 0 || winHref.indexOf("response") >= 0) {
